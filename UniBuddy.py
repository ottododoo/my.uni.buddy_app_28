...
# Function to handle 429 errors with exponential backoff
...
if user_input := st.chat_input("How may I help you?"):
    ...
    with st.spinner("Uncovering knowledge about studying in Germany..."):
        ...
        try:
            # Send question to chain to get answer with retry mechanism
            answer = send_with_retry(chain, user_input)
